...
class Tablero:
    ...
    def terminar(self):
        ...
        for i in self.jugadores:
            if(i.puntuacion>mayor.puntuacion):
                mayor=i
        print("Gano el jugador "+ mayor.nombre+" con " + str(mayor.puntuacion)+" puntos")
        run=False
        sys.exit(0)
    ...
    def crearTablero(self):
        for i in range(0,23):
            arreglo=[]
            for j in range(0,23):
                casilla=Casillas([j*34,i*34],"imagenes/cuadro.png")
        ...
        self.Grafo.mueveNodos(self.fichasPuestas, 23, 23)

    def agrandarTablero(self):
        self.pixeles=800//(self.colFil+1)
        self.colFil+=1
        nuevaMatriz=[]
    ...
    def crearJugadores(self):
        rect1 = (1000, 50, 250, 50)
        rect2 = (1000, 140, 250, 50)
        rect3 = (1000, 230, 250, 50)
        ...
        screen.blit(NormalFont.render(Hplayer.nombre+": "+str(Hplayer.puntuacion), 1, Hplayer.color), (1000, 22))
        screen.blit(NormalFont.render(A1player.nombre+": "+str(A1player.puntuacion), 1, A1player.color), (1000, 112))
        screen.blit(NormalFont.render(A2player.nombre+": "+str(A2player.puntuacion), 1, A2player.color), (1000, 202))
    ...
    def updateJugadores(self):           #metodo que actualiza los labels de cada jugador
        ...
        for player in self.jugadores:
            screen.fill(pygame.Color(255,255,255), (1000, i, 200, 20))
            screen.blit(NormalFont.render(player.nombre+": "+str(player.puntuacion), 1, player.color), (1000,i))
            i+=90
    ...
    def cambiarTurno(self):
        ...
        screen.fill(pygame.Color(255,255,255), (1000,450,200,100)) # elimina todo lo que tenga en esas cordenadas para poder reemplazar el label
        NormalFont=pygame.font.SysFont("Times New Roman", 22)
        screen.blit(NormalFont.render("Turno del jugador: " + str(self.turno),1,NEGRO), (1000, 450))
...
NormalFont=pygame.font.SysFont("monospace", 18)
screen.blit(NormalFont.render("Ficha seleccionada: ", 1, NEGRO), (1000, 350))
...
while run:
    ...
    casilla=Casillas([1000,400],"imagenes/cuadro.png")
    rect = (1000, 400, 50,50)
